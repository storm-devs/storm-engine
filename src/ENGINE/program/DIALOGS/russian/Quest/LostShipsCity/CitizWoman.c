	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Здравствуйте, сэр. Я очень рада, вы сумели спастить после этой ужасной катастрофы... Хотя что говорить, мы все через это прошли. Да, меня зовут " + GetFullName(npchar) + ".";
