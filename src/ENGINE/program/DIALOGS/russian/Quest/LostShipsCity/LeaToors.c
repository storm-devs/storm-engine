	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Приветствую вас, минхер, у себя дома, вы можете переждать у меня этот шторм. Меня зовут " + GetFullName(npchar) + ".";
					link.l1 = "А я - капитан " + GetFullName(pchar) + ". Переждать шторм, говорите?";
					link.l1.go = "FS_1";
				}
				else
				{
					dialog.text = "Приветствую вас, минхер, у себя дома. Меня зовут " + GetFullName(npchar) + ".";
		...
		break;
		case "FS_1":
			dialog.text = "Да, вы можете находиться здесь сколь угодно. Закон гласит, что каждый хозян дома в Городе должен давать приют нуждающемуся во время буйства стихии. Сейчас как раз такое время.";
		...
		case "int_quests":
			...
			{
				link.l1 = "И как вам быть хозяйкой этого дома?";
