	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				{
					dialog.text = "Здравствуйте! Я рада, что вы зашли ко мне в дом. Вы знаете, в этом ужасном шторме выжили, похоже, только вы... Ой, простите, сэр, меня зовут " + GetFullName(npchar) + ". Как вы уже, наверное, поняли, что я хозяйка этой каюты.";
					link.l1 = GetFullName(pchar) + " к вашим услугам. Рад приветствовать гостеприимных хозяев.";
					link.l1.go = "FS_1";
				}
				else
				{
					dialog.text = "Здравствуйте! Я рада, что вы зашли ко мне в дом. Вы знаете, в том ужасном последнем шторме выжили, похоже, только вы... Ой, простите, сэр, меня зовут " + GetFullName(npchar) + ". Как вы уже, наверное, поняли, я хозяйка этой каюты.";
					link.l1 = GetFullName(pchar) + " к вашим услугам. Рад приветствовать гостеприимных хозяев.";
					link.l1.go = "FT_1";
				}
			}
		...
		case "FS_2":
			...
			link.l1 = "Я так же рад знакомству с приятным в общении человеком. Я так понимаю, что Город немноголюден.";
			link.l1.go = "FT_2";
		break;

		case "FT_1":
			dialog.text = "Вы знаете, сейчас погода хорошая. Но я бываю иногда даже рада, что начинается буря и застигнутые на 'Веласко' люди остаются у меня, что переждать непогоду. Есть с кем поговорить...";
