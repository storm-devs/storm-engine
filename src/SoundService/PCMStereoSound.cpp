...
#ifndef _XBOX
DWORD BUFFER_CAPS = DSBCAPS_CTRLPAN | DSBCAPS_CTRLVOLUME | DSBCAPS_CTRLPOSITIONNOTIFY | DSBCAPS_CTRLFREQUENCY |
                    DSBCAPS_GETCURRENTPOSITION2 | DSBCAPS_LOCSOFTWARE;
#else
DWORD BUFFER_CAPS = DSBCAPS_CTRLVOLUME | DSBCAPS_CTRLPOSITIONNOTIFY | DSBCAPS_CTRLFREQUENCY;
#endif
...
//--------------------------------------------------------------------
PCMStereoSound::PCMStereoSound(const PCMStereoSound &_source) : VSound(_source.volumeType)
{
...
//--------------------------------------------------------------------
bool PCMStereoSound::Play(const char *_name, bool _simpleCache /* = false*/, long _time /* = 0*/,
                          ...
                          float _maxDistance /*= -1.0f*/, long _loopPauseTime /*= 0*/, float _volume /*= 1.0f*/)
{
    ...
    {
        if (!CreateBuffer(BUFFER_CAPS, dataSize, waveFormat, cachedData))
            return false;
