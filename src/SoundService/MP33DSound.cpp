...
//--------------------------------------------------------------------
MP33DSound::MP33DSound(LPDIRECTSOUND8 _ds8, bool _looped, bool _cached, eVolumeType _volumeType) : VSound(_volumeType)
{
...
//--------------------------------------------------------------------
bool MP33DSound::Play(const char *_name, bool _simpleCache /*= false*/, long _time /* = 0*/,
...
#ifndef _XBOX
    if (!CreateBuffer(DSBCAPS_CTRL3D | DSBCAPS_CTRLVOLUME | DSBCAPS_CTRLPOSITIONNOTIFY | DSBCAPS_GETCURRENTPOSITION2 |
                          DSBCAPS_MUTE3DATMAXDISTANCE,
                      chunkInfo.cksize, waveFormat))
        return false;
#else
    if (!CreateBuffer(DSBCAPS_CTRL3D | DSBCAPS_CTRLVOLUME | DSBCAPS_CTRLPOSITIONNOTIFY, chunkInfo.cksize, waveFormat))
        return false;
#endif
