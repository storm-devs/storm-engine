#ifndef BI_SEAINTERFACE_DEFINES_H
#define BI_SEAINTERFACE_DEFINES_H

// icons control defines
#define BI_MSG_COMMAND_ACTIVATE 1
#define BI_MSG_COMMAND_RIGHT 2
#define BI_MSG_COMMAND_LEFT 3
#define BI_MSG_COMMAND_DEACTIVATE 4

#define LI_COMMANDS_ACTIVATE "LICommandsActivate"
#define BI_COMMANDS_ACTIVATE "BICommandsActivate"
