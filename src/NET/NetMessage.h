...
class NMSend
{
  public:
    ...
    void AddByte(byte b)
    {
        NM_DEBUG_ADD(NM_BYTE);
        AddData(&b, sizeof(b));
    }
    void AddWord(word w)
    {
        NM_DEBUG_ADD(NM_WORD);
        AddData(&w, sizeof(w));
    }
    void AddDword(dword d)
    {
        NM_DEBUG_ADD(NM_DWORD);
        AddData(&d, sizeof(d));
    }
    void AddDword_NoDbg(dword d)
    {
        AddData(&d, sizeof(d));
    }
    void AddFloat(float f)
    {
        NM_DEBUG_ADD(NM_FLOAT);
        AddData(&f, sizeof(f));
    }
