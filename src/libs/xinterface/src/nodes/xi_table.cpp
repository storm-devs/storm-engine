...
void XI_TableLineDescribe::DrawSpecColor(float fTop) const
{
    if (m_bUseSpecColor)
    {
        ...
        for (int i = 0; i < 4; i += 4)
        {
            ...
            vertices.push_back(VERTEX_POSITION_COLOR{pVertices[i + 0].pos.x, pVertices[i + 0].pos.y,
                                                     pVertices[i + 0].pos.z, pVertices[i + 0].color});
            vertices.push_back(VERTEX_POSITION_COLOR{pVertices[i + 2].pos.x, pVertices[i + 2].pos.y,
                                                     pVertices[i + 2].pos.z, pVertices[i + 1].color});
            vertices.push_back(VERTEX_POSITION_COLOR{pVertices[i + 1].pos.x, pVertices[i + 1].pos.y,
                                                     pVertices[i + 1].pos.z, pVertices[i + 1].color});
            vertices.push_back(VERTEX_POSITION_COLOR{pVertices[i + 3].pos.x, pVertices[i + 3].pos.y,
                                                     pVertices[i + 3].pos.z, pVertices[i + 3].color});
