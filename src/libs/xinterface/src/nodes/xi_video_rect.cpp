    ...
    if (m_bUse)
    {
        if (auto *const ptr = EntityManager::GetEntityPointer(m_eiVideo))
        {
            ...
            if (pTex != nullptr)
            {
                ...
                vertices.push_back(VERTEX_POSITION_TEXTURE_COLOR{v[0].pos.x, v[0].pos.y, v[0].pos.z, v[0].tu, v[0].tv,
                v[0].color}); vertices.push_back( VERTEX_POSITION_TEXTURE_COLOR{v[2].pos.x, v[2].pos.y, v[2].pos.z,
                v[2].tu, v[2].tv, v[1].color}); vertices.push_back( VERTEX_POSITION_TEXTURE_COLOR{v[1].pos.x,
                v[1].pos.y, v[1].pos.z, v[1].tu, v[1].tv, v[2].color}); vertices.push_back(
