...
void CXI_BORDER::LoadIni(INIFILE *ini1, const char *name1, INIFILE *ini2, const char *name2)
{
    ...
    if (m_nLeftLinePicture < 0)
    {
        ...
        pPictureService->BGFXGetTexturePos(m_nLeftLinePicture, m_frLeftLineUV);
...
void CXI_BORDER::FillVertexBuffers()
{
    ...
    */
    ...
    WriteVertexForSquare(16, m_frLeftTopUV, m_dwColor, m_rect.left, m_rect.top, m_rect.left + m_pntLeftTopSize.x,
                         m_rect.top + m_pntLeftTopSize.y);
    // right top corner
    WriteVertexForSquare(20, m_frRightTopUV, m_dwColor, m_rect.right - m_pntRightTopSize.x, m_rect.top, m_rect.right,
...
void CXI_BORDER::WriteVertexForSquare(uint32_t index, FXYRECT &UVRect, uint32_t dwColor, int32_t left, int32_t top,
                                      int32_t right, int32_t bottom)
{
