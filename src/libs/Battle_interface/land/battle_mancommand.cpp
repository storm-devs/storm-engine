...
long BIManCommandList::CommandAdding()
{
    ...
    for (long i = 0; i < attrQuant; i++)
    {
        ...
        retVal +=
            AddToIconList(texNum, pictureNum, selPictureNum, -1, -1, eventName, -1, null, pA->GetAttribute("note"));
    }
    return retVal;
}
...
long BIManCommandList::AbilityAdding()
{
    ...
    for (long i = 0; i < attrQuant; i++)
    {
        ...
        char *eventName = pA->GetAttribute("event");
        retVal +=
            AddToIconList(textureNum, pictureNum, selPictureNum, -1, -1, eventName, -1, null, pA->GetAttribute("note"));
    }
    return retVal;
}
