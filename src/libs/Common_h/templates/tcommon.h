...
inline void __XxX_Assert__(bool expression)
{
    if (!expression)
        _asm int 3
}
...
inline void *operator new(size_t Size, char c, void *pAddress)
{
    return pAddress;
}
...
template <class _Ty> class allocator
{
  public:
    ...
    __forceinline dword GetMaxElements()
    {
        return dwMaxElements;
    }
