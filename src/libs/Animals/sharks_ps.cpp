...
// node ----------------------------------------------------------------------------
SHARKS_PS *SHARKS_PS::GetLeftNode()
{
    return l_PTR;
}
SHARKS_PS *SHARKS_PS::GetRightNode()
{
    return r_PTR;
}
void SHARKS_PS::SetLeftNode(SHARKS_PS *node)
{
    l_PTR = node;
}
void SHARKS_PS::SetRightNode(SHARKS_PS *node)
{
    r_PTR = node;
}
...
void SHARKS_PS::SetTrackPoint(long _index, CVECTOR _pos)
{
    ...
    if (_index >= nFlowTrackSize)
        return; //_THROW(flow track overflow);
