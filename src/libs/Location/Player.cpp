        ...
        if (collide)
        {
            ...
            if (dist <= 1.0f && dist > (0.2f / 25.0f))
            {
                ...
                if (e && e != this)
                {
                    ...
                    if (n >= nm)
                        api->Send_Message(effects, "sffffff", "SGEnvParticles", dst.x, dst.y, dst.z, dir.x, dir.y,
                                          dir.z);
                }
                else
                    api->Send_Message(effects, "sffffff", "SGEnvParticles", dst.x, dst.y, dst.z, dir.x, dir.y, dir.z);
            }
        }
    }
