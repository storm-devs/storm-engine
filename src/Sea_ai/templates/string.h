...
class string
{
  ...
  public:
    ...
    // string compare
    inline bool operator==(string &s1)
    {
        return (GetBuffer() && s1.GetBuffer()) ? stricmp(GetBuffer(), s1) == 0 : false;
    }
    inline bool operator==(char *pString)
    {
        return GetBuffer() ? stricmp(GetBuffer(), pString) == 0 : false;
    }
