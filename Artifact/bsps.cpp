...
// node ----------------------------------------------------------------------------
BSPS_PS *BSPS_PS::GetLeftNode()
{
    return l_PTR;
}
BSPS_PS *BSPS_PS::GetRightNode()
{
    return r_PTR;
}
void BSPS_PS::SetLeftNode(BSPS_PS *node)
{
    l_PTR = node;
}
void BSPS_PS::SetRightNode(BSPS_PS *node)
{
    r_PTR = node;
}
