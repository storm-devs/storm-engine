...
class Curve5
{
  public:
    ...
    __forceinline void SetLine(const CVECTOR &v0, const CVECTOR &v1, const CVECTOR &v2, const CVECTOR &v3,
                               const CVECTOR &v4);
...
__forceinline void Curve5::SetLine(const CVECTOR &v0, const CVECTOR &v1, const CVECTOR &v2, const CVECTOR &v3,
                                   const CVECTOR &v4)
{
    vP0 = v0;
