...
class IFS : public INIFILE
{
  ...
  public:
    ...
    bool ReadString(SEARCH_DATA *sd, char *section_name, char *key_name, char *buffer, dword buffer_size,
                    char *def_string);
    void ReadString(SEARCH_DATA *sd, char *section_name, char *key_name, char *buffer,
                    dword buffer_size); // rise exception on fault
