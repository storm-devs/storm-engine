...
#define INTERFACE_RANSACK_MAIN                                                                                         \
    5 // более не при делах, но где-то идут проверки на определение, вызов  INTERFACE_TRANSFER_MAIN по сути, но с
      // поправкой на море и абордаж
