...
find_path(Fmod_INCLUDE_DIR fmod.h "${STORM_EXTERN_DIR}/fmod/api/inc")
...
if(CMAKE_CL_64)
    set(Fmod_LIBRARY_PATHS "${Fmod_ROOT_DIR}/api/lib/x64")
else()
    set(Fmod_LIBRARY_PATHS "${Fmod_ROOT_DIR}/api/lib/x86")
endif()
