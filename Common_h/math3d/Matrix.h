...
//Посчитать матрицу проекции для тени
mathinline Matrix &Matrix::BuildShadowProjection(float viewAngle, float vpWidth, float vpHeight, float zNear,
                                                 float zFar)
{
    //Обнулим массив
    _asm
...
//Споецировать массив вершин (для матрицы проекции)
mathinline void Matrix::Projection(Vector4 *dstArray, Vector *srcArray, long num, float vphWidth05, float vphHeight05,
