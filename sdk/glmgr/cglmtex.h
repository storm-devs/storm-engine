...
class CGLMTexLayoutTable
{
  public:
    ...
    GLMTexLayout *NewLayoutRef(
        GLMTexLayoutKey *key);               // pass in a pointer to layout key - receive ptr to completed layout
...
class CGLMTex
{
  ...
  protected:
    ...
    bool m_rboDirty;  // has RBO been drawn on - i.e. needs to be blitted back to texture if texture is going to be
                      // sampled from
