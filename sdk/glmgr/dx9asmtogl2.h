...
#define D3DToGL_OptionDoUserClipPlanes                                                                                 \
    0x008 // ARB mode: Include OPTION vertex_program_2 and append DP4's to write into oCLP[0] and oCLP[1]
...
#define D3DToGL_PutHexCommentsAfterLines                                                                               \
    0x040 // If D3DToGL_AddHexComments is set, this puts the codes to the right, rather than on separate lines
#define D3DToGL_GeneratingDebugText                                                                                    \
    0x080 // This tells it that we're just getting info for debugging so go easy on asserts and errors
