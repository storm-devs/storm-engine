...
// fast context mode means that a single GL context is used both for the window and the engine, saving on sync and
// flushes. it's only a suggestion; if the OS is below 10.6.2 it will be ignored.
...
GLMValueEntry_t g_d3d_devtypes[] = {VE(D3DDEVTYPE_HAL), VE(D3DDEVTYPE_REF),
...
GLMValueEntry_t g_d3d_rtypes[] = {VE(D3DRTYPE_SURFACE),
                                  VE(D3DRTYPE_TEXTURE),
...
GLMValueEntry_t g_d3d_usages[] = {VE(D3DUSAGE_RENDERTARGET), VE(D3DUSAGE_DEPTHSTENCIL), VE(D3DUSAGE_DYNAMIC),
                                  ...
                                  VE(D3DUSAGE_WRITEONLY), VE(D3DUSAGE_SOFTWAREPROCESSING), VE(D3DUSAGE_DONOTCLIP),
                                  VE(D3DUSAGE_POINTS), VE(D3DUSAGE_RTPATCHES), VE(D3DUSAGE_NPATCHES),

                                  VE(TERMVALUE)};

GLMValueEntry_t g_d3d_rstates[] = {VE(D3DRS_ZENABLE),
                                   VE(D3DRS_FILLMODE),
                                   VE(D3DRS_SHADEMODE),
...
GLMValueEntry_t g_gl_errors[] = {VE(GL_INVALID_ENUM),
                                 VE(GL_INVALID_VALUE),
...
GLMValueEntry_t g_gl_enums[] = {{0x0000, "GL_ZERO"},
                                {0x0001, "GL_ONE"},
                                {0x0004, "GL_TRIANGLES"},
...
GLMValueEntry_t g_gl_renderers[] = {{0x00020200, "Generic"},
...
void GLMCheckError(bool noStop,
                   bool noLog) // caller can force off, but not on.  Debugger can force all to be off (flip the chars).
{
