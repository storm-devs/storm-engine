...
class CUtlBuffer
{
  public:
    enum BufferFlags_t
    {
        ...
        // EXTERNAL_GROWABLE = 0x2,		// This is used w/ external buffers and causes the utlbuf to switch to
        // reallocatable memory if an overflow happens when Putting. CONTAINS_CRLF = 0x4,			// For text buffers
        // only, does this contain \n or \n\r?
