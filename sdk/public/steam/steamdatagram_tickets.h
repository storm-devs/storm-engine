...
struct SteamDatagramRelayAuthTicket
{
    ...
    struct ExtraField
    {
        ...
        {
            k_EType_String,
            k_EType_Int, // For most small integral values.  Uses google protobuf sint64, so it's small on the wire.
                         // WARNING: In some places this value may be transmitted in JSON, in which case precision may
                         // be lost in backend analytics.  Don't use this for an "identifier", use it for a scalar
                         // quantity.
            k_EType_Fixed64, // 64 arbitrary bits.  This value is treated as an "identifier".  In places where JSON
                             // format is used, it will be serialized as a string.  No aggregation / analytics can be
