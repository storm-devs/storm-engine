...
class ISteamPS3OverlayRenderHost
{
  public:
    ...
    // Draw a textured rect.  This may use only part of the texture and will pass texture coords, it will also possibly
    // request a gradient and will specify colors for vertexes.
    ...
    // Load a RGBA texture for Steam, or update a previously loaded one.  Updates may be partial.  You must not evict or
    // remove this texture once Steam has uploaded it.
...
class ISteamPS3OverlayRender
{
  public:
    ...
    // Call this once a frame when you are ready for the Steam overlay to render (ie, right before flipping buffers,
    // after all your rendering)
