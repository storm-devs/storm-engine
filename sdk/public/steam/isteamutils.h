...
class ISteamUtils
{
  public:
    ...
    //   bLegalOnly should be false if you want profanity and legally required filtering (where required) and true if
    //   you want legally required filtering only Returns the number of characters (not bytes) filtered.
    virtual int FilterText(char *pchOutFilteredText, uint32 nByteSizeOutFilteredText, const char *pchInputMessage,
                           bool bLegalOnly) = 0;
};
