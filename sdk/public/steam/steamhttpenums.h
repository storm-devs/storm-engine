...
enum EHTTPStatusCode
{
    ...
    k_EHTTPStatusCode401Unauthorized =
        401, // You probably want 403 or something else. 401 implies you're sending a WWW-Authenticate header and the
             // client can sent an Authorization header in response.
