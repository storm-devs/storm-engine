...
class CMusicPlayerMenu : public CBaseMenu<MusicPlayerMenuItem_t>
{
  public:
    ...
    CMusicPlayerMenu(IGameEngine *pGameEngine)
        : CBaseMenu<MusicPlayerMenuItem_t>(pGameEngine), m_menuItemPause("Pause"), m_menuItemPlay("Play"),
          m_menuItemPlayPrevious("Play Previous"), m_menuItemPlayNext("Play Next"),
          m_menuItemIncreaseVolume("Increase Volume"), m_menuItemDecreaseVolume("Decrease Volume"),
          m_menuItemBack("Back")
    {
    }
...
CMusicPlayer::CMusicPlayer(IGameEngine *pGameEngine)
    : m_pGameEngine(pGameEngine), m_CallbackVolumeChanged(this, &CMusicPlayer::OnVolumeChanged),
