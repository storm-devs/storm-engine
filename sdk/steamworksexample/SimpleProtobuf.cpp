...
#ifdef VALVE_BIG_ENDIAN
    strProtobuf.append(std::const_reverse_iterator<const char *>(pData + 8),
                       std::const_reverse_iterator<const char *>(pData));
#else
...
#ifdef VALVE_BIG_ENDIAN
    strProtobuf.append(std::const_reverse_iterator<const char *>(pData + 4),
                       std::const_reverse_iterator<const char *>(pData));
#else
...
#ifdef VALVE_BIG_ENDIAN
    std::copy(std::const_reverse_iterator(pParsePosition + 4), std::const_reverse_iterator(pParsePosition),
              reinterpret_cast<char *>(&flValue));
#else
...
#ifdef VALVE_BIG_ENDIAN
    std::copy(std::const_reverse_iterator(pParsePosition + 8), std::const_reverse_iterator(pParsePosition),
              reinterpret_cast<char *>(&flValue));
#else
...
template <typename T>
static bool ProtobufReadRepeated_T(const char *&pParsePosition, const char *pParseEnd, uint32 uFieldTag,
                                   std::vector<T> &vecData, bool (*pfnRead)(const char *&, const char *, T &))
{
    if ((uFieldTag & 7) == 2)
    {
...
template <typename T>
static bool ProtobufExtractField_T(const char *pParsePosition, const char *pParseEnd, uint32 uFieldTag, T &value,
                                   bool (*pfnRead)(const char *&, const char *, T &))
{
...
template <typename T>
static bool ProtobufExtractField_T(const char *pParsePosition, const char *pParseEnd, uint32 uFieldTag, T &value,
                                   bool (*pfnRead)(const char *&, const char *, uint32, T &))
{
    uint32 uCurrentTag = 0;
    bool bOK = false;
    while (ProtobufReadFieldTag(pParsePosition, pParseEnd, uCurrentTag))
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), value, &ProtobufReadInteger);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), value, &ProtobufReadSInteger);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), value, &ProtobufReadFixed64);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), value, &ProtobufReadFixed32);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_STRING(uFieldNumber), value, &ProtobufReadString);
}

bool ProtobufExtractField_Integer(const std::string &strProtobuf, uint32 uFieldNumber, std::vector<uint64> &vec)
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_INTEGER(uFieldNumber), vec, &ProtobufReadRepeatedInteger);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_SINTEGER(uFieldNumber), vec, &ProtobufReadRepeatedSInteger);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_FIXED64(uFieldNumber), vec, &ProtobufReadRepeatedFixed64);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_FIXED32(uFieldNumber), vec, &ProtobufReadRepeatedFixed32);
}
...
{
    return ProtobufExtractField_T(strProtobuf.data(), strProtobuf.data() + strProtobuf.size(),
                                  PROTOBUF_FIELDTAG_STRING(uFieldNumber), vec, &ProtobufReadRepeatedString);
}
