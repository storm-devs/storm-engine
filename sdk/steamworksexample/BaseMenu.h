  ...
  public:
    ...
    virtual void Render()
    {
        ...
        if (m_sHeading.length())
        {
            ...
            m_pGameEngine->BDrawString(g_hMenuFont, rectHeader, dwColor, TEXTPOS_CENTER | TEXTPOS_VCENTER,
                                       m_sHeading.c_str());
        }
        ...
        if (iStartItem > 0)
        {
            ...
            m_pGameEngine->BDrawString(g_hMenuFont, rect, dwColor, TEXTPOS_CENTER | TEXTPOS_VCENTER,
                                       "... Scroll Up ...");
