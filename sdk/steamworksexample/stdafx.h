...
#define COLOR_RED(color) (GLubyte)(((color) >> 16) & 0xff)

#define COLOR_GREEN(color) (GLubyte)(((color) >> 8) & 0xff)

#define COLOR_BLUE(color) (GLubyte)((color)&0xff)

#define COLOR_ALPHA(color) (GLubyte)(((color) >> 24) & 0xff)

#define DWARGB_TO_DWRGBA(color)                                                                                        \
    ((DWORD)(((((((color) >> 16) & 0xff)) << 24) | (((((color) >> 8) & 0xff)) << 16) | ((color & 0xff) << 8) |         \
              ((color) >> 24) & 0xff)))

#define DWARGB_TO_DWABGR(color)                                                                                        \
    ((DWORD)(((((((color) >> 24) & 0xff)) << 24) | (((((color)) & 0xff)) << 16) | (((color >> 8) & 0xff) << 8) |       \
              ((color) >> 16) & 0xff)))

#define DWRGBA_TO_DWARGB(color)                                                                                        \
    ((DWORD)(((((((color)) & 0xff)) << 24) | (((((color >> 24)) & 0xff)) << 16) | (((color >> 16) & 0xff) << 8) |      \
              ((color) >> 8) & 0xff)))
